...
export const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    purpose: 'Importa eventos reais para a agenda.',
    canImport: true,
    caveat: 'Cobertura no Brasil é parcial (grandes casas e turnês).',
  },
  {
    id: 'bandsintown',
    label: 'Bandsintown',
...
export async function importTicketmaster(
  sb: any,
  opts: { city?: string; lat?: number; lng?: number; radiusKm?: number; size?: number } = {},
